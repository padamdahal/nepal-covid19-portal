    ...
    makePlotlyChart = function(traceOptions, layoutOptions, transpose) {
      ...
      return function(pivotData, opts) {
        ...
        defaults = {
          ...
          plotly: {},
		  //plotlyConfig: {}
          plotlyConfig: {displaylogo: false, modeBarButtonsToRemove: ['pan2d','select2d','lasso2d','resetScale2d','zoom','zoomOut2d','zoomIn2d','drawclosedpath','drawopenpath','autoScale2d','hoverClosestCartesian','hoverCompareCartesian','toggleSpikelines']}
        };
